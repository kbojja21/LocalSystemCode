 ...
 */
public abstract class ParentTestClass extends TestCase {
    private static final String CONFIG_LOCATIONS = "classpath:applicationContext.xml";
    ...
    public ParentTestClass(String name) {
        super(name);
    }
    ...
    protected void setUp() throws Exception {
        ...
        params.put("actionPackages", "com.model");
